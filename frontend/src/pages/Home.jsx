...
const Home = () => {
  ...
  const StatItem = ({ value, label }) => {
    ...
    return (
      ...
      >
        <h3 className="text-4xl font-bold text-gray-900 dark:text-brand-200 mb-2">
          {formatValue()}
        </h3>
    ...
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <span className="inline-flex items-center gap-2 rounded-full bg-brand-100 text-gray-900 px-4 py-2 text-sm font-semibold">
                <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-brand-300 text-gray-900 text-xs">
                  ✦
                </span>
                AI-Powered Campus Placement Platform
              </span>
              <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight text-gray-900">
                Land Your <span className="text-gray-900">Dream Job</span> with
                Smart Resume Matching
              </h1>
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                Streamline campus recruitment with AI-driven resume screening,
                skill matching, and real-time analytics. Connect students with
            ...
            >
              ...
              >
                ...
                <div className="mt-4 h-2 rounded-full bg-brand-50">
                  <div
                    className="h-2 rounded-full bg-brand-300"
                    style={{ width: "92%" }}
                  ></div>
                </div>
              </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                interests, and goals with our advanced machine learning
                algorithms.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Find jobs that perfectly match your profile and career
                aspirations with intelligent filtering and recommendation
                systems.
              </p>
            </motion.div>
      ...
      <section className="py-20 bg-brand-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            {user ? "Get Career Recommendations" : "Get Started Today"}{" "}
